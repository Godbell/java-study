 ...
 * or run {@linkplain #setPort(String)} with created server instance.
 * </p>
 */
public class ChatServerEntity implements RemoteServer {
	...
	private Map<String, ChatServerThread> connections;
	...
	public void broadcast(String text) {
		synchronized (this.connections) {
			for (String key : this.connections.keySet()) {
				this.connections.get(key).sendText(text);
			}
		}
	}
